  ...
  { "goolord/alpha-nvim", dependencies = { "nvim-tree/nvim-web-devicons" },
    config = function()
      ...
      dashboard.section.buttons.val = {
        ...
        dashboard.button("e", "  Edit Qtile", ":e ~/nixos-testing/home/system/qtile/config.py<CR>"),
        dashboard.button("c", "  Configuration", ":e ~/nixos-testing/home/apps/nvim/init.lua<CR>"),
...
vim.api.nvim_set_keymap("n", "<leader>fd", ":Telescope find_files hidden=false<CR>", { noremap = true, silent = true })
